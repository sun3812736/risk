 ...
 */
public class CFNetworkObserver extends BroadcastReceiver {

	/** Debug mode */
	private static final boolean DEBUG = StaticsConfig.DEBUG;
	/** LOG Tag */
	private static final String LOG_TAG = CFNetworkObserver.class.getSimpleName();
	/** Context */
	 ...
	 *            INetworkListener
	 */
	public CFNetworkObserver(Context aContext, INetworkListener aListener) {
		mContext = aContext;
		mListener = aListener;
