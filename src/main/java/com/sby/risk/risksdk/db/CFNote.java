package com.sby.risk.risksdk.db;
...
public class CFNote {
    ...
    public CFNote(Long id) {
        this.id = id;
    }

    public CFNote(Long id, String firstCloumn, String secondCloumn, String thirdCloumn, String forthCloumn) {
        this.id = id;
